...
kexperimento  <- 8   #NA si se corre la primera vez, un valor concreto si es para continuar procesando

kscript           <- "682_lgb_prob_auto"
karch_generacion  <- "paquete_premium_202009_ext7.csv"
karch_aplicacion  <- "paquete_premium_202011_ext7.csv"
...
ksemilla_azar  <- 454823  #Aqui poner la propia semilla
...
EstimarGanancia_lightgbm  <- function( x )
{
  ...
  if(  ganancia > GLOBAL_ganancia_max )
  {
    ...
    fwrite( tb_importancia, 
            file= paste0(kimp, "imp_", GLOBAL_iteracion, ".csv"),
            sep="," )
...
kbayesiana  <- paste0("~/buckets/b1/work/E",  kexperimento, "_", kscript, ".RDATA" )
klog        <- paste0("~/buckets/b1/work/E",  kexperimento, "_", kscript, ".txt" )
kimp        <- paste0("~/buckets/b1/work/E",  kexperimento, "_", kscript, "_" )
kkaggle     <- paste0("~/buckets/b1/kaggle/E",kexperimento, "_", kscript, "_" )
