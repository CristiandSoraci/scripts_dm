#ource("~/buckets/b1/crudoB/R/847_epic_stacking.r")
...
karch_dataset    <- "dataset_epic_simple_v009.csv.gz"   #este dataset se genero en el script 812_dataset_epic.r
...
hs <- makeParamSet( 
  ...
  # makeIntegerParam("num_iterations",   lower=25L   , upper= 2000L)
)
