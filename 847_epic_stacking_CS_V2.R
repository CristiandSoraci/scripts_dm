...
kexperimento  <- 10   #NA si se corre la primera vez, un valor concreto si es para continuar procesando
...
karch_dataset    <- "dataset_epic_simple_v008.csv.gz"   #este dataset se genero en el script 812_dataset_epic.r
