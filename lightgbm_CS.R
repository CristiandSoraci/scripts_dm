...
#cargo el dataset
dataset  <- fread("paquete_premium_202009_dec.csv")
...
dapply  <- fread("paquete_premium_202011_dec.csv")
...
imp=lgb.importance(modelo)

fwrite(imp,file="importance_dec.csv",sep=",")
