...
setwd("~/buckets/b1/datasets" )  #establezco la carpeta donde voy a trabajar

#cargo el dataset
dataset  <- fread("paquete_premium_202009_ext3.csv")
...
dapply  <- fread("paquete_premium_202011_ext3.csv")
...
mp=lgb.importance(modelo)

fwrite(imp,file="importance_ext3.csv",sep=",")
