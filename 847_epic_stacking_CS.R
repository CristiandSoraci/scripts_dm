...
kexperimento  <- 9   #NA si se corre la primera vez, un valor concreto si es para continuar procesando
...
karch_dataset    <- "dataset_stacking_v007.csv.gz"   #este dataset se genero en el script 812_dataset_epic.r
...
campos_malos  <- c("internet", "cmobile_app_trx", "tmobile_app","mforex_sell",
                   "cforex_sell", "cforex","mcaja_ahorro_dolares")   #aqui se deben cargar todos los campos culpables del Data Drifting
