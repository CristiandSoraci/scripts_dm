...
hs <- makeParamSet( 
  ...
  makeIntegerParam("max_bin"   ,       lower=  5L   , upper= 100L),
  makeIntegerParam("min_data_in_leaf", lower=  100L   , upper= 8000L),
  makeIntegerParam("num_leaves",       lower=    8L   , upper= 256L) ## Agrandar?? seria prof 8
)
...
campos_malos  <- c("ccajeros_propios_descuentos","mcajeros_propios_descuentos", "ctarjeta_visa_descuentos", "mtarjeta_visa_descuentos",
...
loguear  <- function( reg, arch=NA, folder="~/buckets/b1/work/", ext=".txt", verbose=TRUE )
{
  archivo  <- arch
...
dir.create( paste0( "~/buckets/b1/work/E",  kexperimento, "/" ) )     #creo carpeta del experimento dentro de work
dir.create( paste0( "~/buckets/b1/kaggle/E",  kexperimento, "/" ) )   #creo carpeta del experimento dentro de kaggle
dir.create( paste0( "~/buckets/b1/kaggle/E",  kexperimento, "/meseta/" ) )   #creo carpeta del experimento dentro de kaggle

kbayesiana    <- paste0("~/buckets/b1/work/E",  kexperimento, "/E",  kexperimento, "_", kscript, ".RDATA" )
klog          <- paste0("~/buckets/b1/work/E",  kexperimento, "/E",  kexperimento, "_", kscript, "_BOlog.txt" )
kimp          <- paste0("~/buckets/b1/work/E",  kexperimento, "/E",  kexperimento, "_", kscript, "_" )
